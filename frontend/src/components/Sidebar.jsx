...
import { LayoutDashboard, Package, CircuitBoard, Factory, BarChart3, ShoppingCart, FileSpreadsheet, LogOut, TrendingUp } from 'lucide-react';
...
const Sidebar = () => {
    ...
    const links = [
        ...
        { name: 'Future Orders', path: '/future-orders', icon: TrendingUp },
